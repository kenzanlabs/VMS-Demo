...
3. Install the Node.js packages from the console's command prompt: `npm install`

## Development

1. To watch all files, run `gulp dev` from the console's command prompt. This will open a browser window. Any changes to files will trigger a browser refresh 
